import type { DeviceKeyBundle } from "./types"
import { PreKeyError } from "./errors"
...
function assertBufferLength(value: unknown, length: number, field: string): void {
